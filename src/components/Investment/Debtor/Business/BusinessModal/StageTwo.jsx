...
const StageTwo = ({isOpen,  setIsOpen, setIsActive}) => {
    function open() {
        setIsOpen(false)
      }
      ...
      <div className="fixed inset-0 bg-black/30" aria-hidden="true">
        <div className="fixed inset-0 flex w-screen items-center justify-center p-4">
          <DialogPanel className="w-[500px] lg:w-[650px] shadow-md space-y-4 border bg-[#FFFFFF] p-12 ">
           ...
           <p className='text-lg font-semibold text-[#0E3B5D] mx-2 py-1'>Payloow.vercel.com</p>
           <div className='flex items-center mx-6 text-black'>
           <img src="/images/copy.png" className='h-4 w-4' alt="copy" />
           </div>
            </div>
           ...
           <div>
            <ul className='flex gap-6'>
              <div className='h-14 w-14 rounded-[50%] bg-[#DBE7FE] flex items-center justify-center'>
