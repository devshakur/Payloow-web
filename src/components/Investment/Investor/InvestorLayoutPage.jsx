...
const navigation = [
    { name: "Dashboard", href: '/investor/dashboard', icon: Chart },
    { name: "Business", href: '/investor/business', icon: BookSaved },
    { name: "My Investments", href: "/investor/investment", icon: AlignBottom },
];
                                ...
                                <Menu as="div" className="relative">
                                    <MenuButton className="-m-1.5 flex items-center p-1.5">
                                        ...
                                        <span className="hidden lg:flex lg:items-center">
                                            ...
                                            />
                                                <span className="relative top-4 right-16 text-sm  text-gray-300">Investor</span>
