...
import BuyersDashboardTwo from "./BuyersDashboardTwo";
import Header0ne from "./Header0ne";
import { useRouter } from "../../../Routes/router";


const navigation = [
  { name: "Main Menu", href: "/easybuy/home", icon: Category2 },
  { name: "Dashboard", href: "/buyers/dashboard", icon: LuStore  },
  { name: "My Order", href: "/my-orders", icon: HiOutlineArchiveBox },
  { name: "Phones", href: "/phones-page", icon: PiDevicesDuotone },
  { name: "Solar", href: "/solar-page", icon: GiElectric },
  { name: "Swap", href: "/swap-product", icon: GoArrowSwitch },
  { name: "Payment", href: "/payment", icon: Card },
  { name: "Installment", href: "/installment", icon: TbMessageStar },
];
...
function BuyersLayoutGen({ children}) {
  ...
  <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
    ...
    <div className="flex flex-1 justify-between items-center">
      ...
      <div className="flex items-center gap-x-4 lg:gap-x-12">
        ...
        <p className="absolute right-[14.7rem] top-4 bg-red-500 shadow-md w-5 h-5 flex justify-center items-center rounded-[50%]"><span className="text-white text-[14px] font-medium">2</span></p>
...
export default BuyersLayoutGen;
