      ...
      <main className="w-full md:w-[600px] bg-[#ffff] shadow-md rounded-lg">
        <section className="w-auto mx-5 my-5">
          ...
          <div className="flex justify-center mt-5">
            <p className="font-poppins text-lg font-[550] text-center leading-6 text-[#1D2433] my-4">
            Your payment was successful! Thank you for your purchase. A confirmation email has been sent to your inbox. 
            </p>
          </div>
