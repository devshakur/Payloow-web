...
//                                 }}
//                             />
//                             <div className='flex flex-row gap-2 h-[10vh]'>
//                                 {amounts.map((item, index) => (
//                                     <span 
//                                         key={index} 
//                                         onClick={() => handlePick(item)} 
//                                         className='h-[65px] w-[20%] rounded-xl flex justify-center items-center text-[24px] font-bold bg-blue-100'
//                                     >
//                                         {item}
//                                     </span>
//                                 ))}
...
//                             />
//                             {formik.touched.amount && formik.errors.amount ? (
//                                 <div style={{ color: 'red', marginTop: "-7px" }}>{formik.errors.amount}</div>
//                             ) : null}

//                             <label htmlFor="phone" className='text-[#101928] text-[16px] font-semibold -pb-8'>Phone Number</label>
//                             <input
//                                 id="outlined-required-3"
//                                 placeholder='PhoneNumber'
//                                 type='tel'
...
//                             />
//                             {formik.touched.phone && formik.errors.phone ? (
//                                 <div style={{ color: 'red', marginTop: "-7px" }}>{formik.errors.phone}</div>
//                             ) : null}

//                             <button
//                                 type="button"
//                                 className='w-full h-[45px] bg-blue-600 text-white font-bold rounded-lg mt-4'
