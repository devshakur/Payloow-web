        ...
        <div className='grid items-center justify-center w-full'>
            <div className='w-screen flex justify-center lg:justify-center lg:-ml-[-10vw] 2xl:ml-[8vw]'>
                <div className='w-full mx-4 h-[550px] md:w-[430px] lg:h-[490px] lg:w-[600px] 2xl:w-[700px] bg-[#FFFFFF] pb-[20px] shadow-md rounded-lg'>
                    <h4 className='flex justify-center text-lg leading-7 font-poppins font-bold my-4'>Confirm Airtime Purchase</h4>
                    <h6 className='flex justify-center font-bold text-[20px] font-poppins leading-5 -mt-3'>{amount}</h6>
                    <section className='h-[97px] w-[95%] mx-2 mt-9'>
                        <div className='flex'>
                            ...
                            <div className='w-[70%] flex justify-end gap-3 ml-6'>
                                ...
                                <p className='text-[13px] font-medium font-poppins leading-5 mt-1 text-[#1D2433CC]'>{network_id} Airtime.</p>
                            </div>
                        </div>
                        <div className='flex justify-between my-1'>
                            <p className='text-[13px] font-medium font-poppins leading-5 mt-1 text-[#1D2433CC]'>Amount</p>
                            <p className='font-normal text-sm font-poppins leading-5 mr-11 text-[#1D2433CC]'>{amount}</p>
                        </div>
                        ...
                        <form className='mx-3 flex flex-col' onSubmit={handleSubmit}>
                            <label htmlFor="pin" className='text-[#101928] text-[14px] font-semibold -pb-8'>Pin</label>
                            <input
