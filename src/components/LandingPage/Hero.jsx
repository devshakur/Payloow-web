      ...
      >
        <div className="max-w-[1440px] mx-auto py-20 md:py-32 md:pt-44 px-5 md:px-20 grid md:grid-cols-2 md:items-center md:gap-10">
          <motion.div
            ...
            className="md:text-left text-center md:space-y-10 space-y-3 md:pt-0 pt-10 relative"
          >
            <ShapeOne />
          ...
          >
            <div className="bg-white p-3 rounded-lg relative w-5/6 mx-auto md:mt-0 mt-10">
              ...
              <motion.div
                ...
                className="w-56 h-20 bg-white rounded-lg absolute md:top-10 bottom-5 -left-10 py-2 px-3"
              >
              ...
              <motion.div
                ...
                className="w-56 h-20 bg-white rounded-lg absolute bottom-10 md:block hidden md:-right-20 -right-10 py-2 px-3"
              >
